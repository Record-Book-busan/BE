...
public class SignInResponseMapper {
    ...
    public static SignInResponse toSignInResponse(Users users, String accessToken, String refreshToken, Instant issuedAt) {
    ...
    public static SignInResponse createSignInResponse(Users users, String accessToken, String refreshToken) {
