...
public class BookmarkService {
	...
	public void unbookmark(Long id, String type){
		...
		if(type == "record"){
			...
			bookmark = bookmarkRepository.findByUserAndRecord(users, record).orElseThrow(
				// TODO : 예외처리 변경
